  ...
  return (
    <Layout className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white px-6 py-12">
      <div className="max-w-4xl text-center">
        <h2 className="text-3xl mt-5 font-bold mb-6 text-blue-400">About Songhub</h2>
        ...
        <div className="border border-blue-400 text-start rounded-lg p-4 mb-6 bg-gray-800">
          <p className="text-lg">
            ...
            Welcome to <span className="font-semibold text-blue-300">Songhub</span>, your ultimate destination for discovering,
        ...
        <div className="border text-start border-blue-400 rounded-lg p-4 mb-6 bg-gray-800">
          <p className="text-lg">
            ...
            tailored to music lovers and independent artists. Whether you're a listener or a creator, Songhub
